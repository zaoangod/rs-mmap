...
//! [`std::io::ErrorKind::Unsupported`]。由于 `MmInner` 从不被构造，`Never` 使其余
...
impl MmInner {
    ...
    pub fn map(_: usize, _: &File, _: u64, _: bool) -> io::Result<MmInner> {
...
/// 返回文件长度。
pub fn get_file_length(file: &File) -> io::Result<u64> {
